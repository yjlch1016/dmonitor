...
RUN sed -i '38,40c <h4 align="center">生产环境接口监控平台</h4><p align="center"><img src="http://attach.sogi.com.tw/upload/200611/200611101824320.gif" alt="雷达"></p>' /usr/local/lib/python3.6/dist-packages/xadmin/templates/xadmin/views/login.html && \
